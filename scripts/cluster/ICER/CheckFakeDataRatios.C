          ...
          for (auto nuspec : {t2knova::kNuMu, t2knova::kNuMub, t2knova::kNuE,
            ...
            for (int mode = 0; mode < 120; ++mode) {
              ...
              if (selstr == "totxsecs") {
                ...
                TH1 *GENIE =
                    GetTH1(&F_FDH,
                           std::string("GENIE/") + detstr + "/" + tgtstr + "/" +
                               t2knova::all_nuspecies[nuspec] + "/" + selstr);
                ...
                if (mode == 0) {
                  ...
                  TH1 *Inputs1D = GetTH1(
                      &F_FDI,
                      std::string("t2knd_to_nova_") + projstr + "_" + tgtstr +
                          "_" + t2knova::all_nuspecies[nuspec] + "_" + selstr);
